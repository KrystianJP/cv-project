    ...
    <div className="input-section">
      ...
      <div className="input-container">
        ...
        <input
          ...
          id="school"
          onChange={(e) => {
            props.changeValues(e.target.value, "SchoolName");
          }}
        ></input>
      </div>
      <div className="input-container">
        ...
        <input
          ...
          id="study-title"
          onChange={(e) => {
            props.changeValues(e.target.value, "StudyTitle");
          }}
        ></input>
      </div>
      <div className="input-container">
        ...
        <div className="dates-container">
          <div>
            ...
            <input
              ...
              onChange={(e) => {
                props.changeValues(e.target.value, "StudyDateFrom");
              }}
            ></input>
          </div>
          <div>
            ...
            <input
              ...
              className="study-date"
              onChange={(e) => {
                props.changeValues(e.target.value, "StudyDateTo");
              }}
            ></input>
          </div>
        </div>
